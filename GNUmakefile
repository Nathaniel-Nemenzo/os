...
ovmf/ovmf-code-$(KARCH).fd ovmf/ovmf-vars-$(KARCH).fd:
	mkdir -p ovmf
	curl -L https://github.com/osdev0/edk2-ovmf-nightly/releases/latest/download/edk2-ovmf.tar.xz -o ovmf/edk2-ovmf.tar.xz
	tar -xf ovmf/edk2-ovmf.tar.xz -C ovmf --strip-components=1
	rm ovmf/edk2-ovmf.tar.xz
